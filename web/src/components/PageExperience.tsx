...
const SERVICE_META: ServiceMeta[] = [
  {
    ...
    activities: [
      ...
      "Инспекция на корпуси и хидросъоръжения",
    ...
    cards: [
      ...
      { title: "Стандарт", value: "IDSA", sub: "международен" },
    ],
  },
  {
    // 1 — ROV инспекции
    ...
    activities: [
      ...
      "Измерване на корозия и деградация",
      "Наблюдение при ограничена видимост",
      "Документация и анализ на данни",
    ],
    cards: [
      { title: "Камера", value: "4K HD", sub: "видео запис" },
      { title: "Дълбочина", value: "300м", sub: "оперативна" },
      { title: "Манипулатор", value: "6-DOF", sub: "управление" },
    ],
  },
  {
    // 2 — Батиметрия
    ...
    activities: [
      ...
      "RTK/GNSS позициониране",
      "3D модели и GIS изходни данни",
    ],
    cards: [
      { title: "Точност", value: "±2см", sub: "GNSS RTK" },
      { title: "Покритие", value: "95%", sub: "на площ" },
      { title: "Изход", value: "DWG/GIS", sub: "формати" },
    ],
  },
  {
    ...
    activities: [
      ...
      "Аварийни протоколи и действия",
    ],
    cards: [
      { title: "Регулация", value: "МОСВ", sub: "лицензиран" },
      { title: "Мониторинг", value: "24/7", sub: "контрол" },
  ...
  },
  {
    ...
    activities: [
      ...
      "Бетонни работи и подводно бетониране",
      "Ремонт на хидравлични съоръжения",
    ],
    cards: [
      { title: "Строителство", value: "СМР", sub: "лицензиран" },
      { title: "Клас", value: "A", sub: "материали" },
      { title: "Гаранция", value: "5 год.", sub: "изпълнение" },
    ],
  },
  {
    // 5 — Водолазни курсове
    ...
    activities: [
      ...
      "Rescue Diver",
      "Специализирани технически курсове",
      "Инструкторски програми NAUI/CMAS",
    ],
    cards: [
      { title: "NAUI", value: "Акред.", sub: "сертификат" },
      { title: "CMAS", value: "★★★", sub: "нива" },
      { title: "Завършили", value: "500+", sub: "обучени" },
    ],
  },
]
